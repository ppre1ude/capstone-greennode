...
- 최신 재감사 산출물: `temp/backend-feature-contract-e2e-20260607T065349Z.json`(기본 `localhost:8080` read-only preflight, `target=local-mock`), `temp/post-mvp-backend-contracts-20260607T065349Z.json`(기본 `localhost:8080`, `/openapi.json` 404, 토큰 부재 skip).
